 ...
 *
 * Run with: npx ts-node scripts/generate-practice-scenarios.ts
 */
...
interface ScenarioConfig {
  ...
  explanation: string;
  tags: string[];
  focusArea: 'level' | 'trend' | 'patience';
  category: string;
  relatedLessonSlug: string;
  decisionContext: string;
}

// Candle generation utilities (inline to avoid import issues)
...
function generateSupportBounce(basePrice: number, vol: number, start: number, interval: number, supportLevel: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generateResistanceRejection(basePrice: number, vol: number, start: number, interval: number, resistanceLevel: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generateVWAPReclaim(basePrice: number, vol: number, start: number, interval: number, vwapLevel: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generateFailedBreakdown(basePrice: number, vol: number, start: number, interval: number, supportLevel: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generateORBBreakout(basePrice: number, vol: number, start: number, interval: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generatePatienceTest(basePrice: number, vol: number, start: number, interval: number, supportLevel: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generateGapFill(basePrice: number, vol: number, start: number, interval: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generateTrendExhaustion(basePrice: number, vol: number, start: number, interval: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generateBelowVWAPShort(basePrice: number, vol: number, start: number, interval: number, vwapLevel: number): GeneratedCandle[] {
  const candles: GeneratedCandle[] = [];
  let time = start;
...
function generateCandlesForScenario(config: ScenarioConfig): GeneratedCandle[] {
...
function generateScenarioSQL(config: ScenarioConfig, candles: GeneratedCandle[]): string {
...
function generateSeedFile(): string {
  const header = `-- ============================================
...
const outputPath = path.join(__dirname, '..', 'supabase', 'seeds', 'practice_scenarios_enhanced.sql');
